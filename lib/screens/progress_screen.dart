...
class _ProgressScreenState extends State<ProgressScreen> {
  ...
  List<FlSpot> _getChartSpots() {
    ...
    // Create cumulative workout count
    List<FlSpot> spots = [];
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  LineChartData(
                                    ...
                                    titlesData: FlTitlesData(
                                      ...
                                      leftTitles: AxisTitles(
                                        sideTitles: SideTitles(
                                          showTitles: true,
                                          reservedSize: 40,
                                          interval: (_getChartSpots().isEmpty ? 1 : (_getChartSpots().last.y / 5)).ceilToDouble(),
                                          getTitlesWidget: (value, meta) {
                                            return Text(
                                    ...
                                    lineBarsData: [
                                      LineChartBarData(
                                        ...
                                        isCurved: true,
                                        gradient: LinearGradient(
                                          colors: [Color(0xFF2E86AB), Color(0xFF1A4D6D)],
                                        ),
                                        barWidth: 5,
                                        ...
                                        belowBarData: BarAreaData(
                                          ...
                                          gradient: LinearGradient(
                                            colors: [
                                              Color(0xFF2E86AB).withOpacity(0.4),
                                              Color(0xFF1A4D6D).withOpacity(0.1),
                                            ],
                                    ...
                                    minX: 0,
                                    maxX: _getChartSpots().isEmpty ? 1 : (_getChartSpots().length - 1).toDouble(),
                                    minY: 0,
                                    maxY: _getChartSpots().isEmpty ? 1 : (_getChartSpots().last.y + 1),
                        ...
                        Center(
                          child: Text(
                            'Total Workouts Added Over Time',
                            style: TextStyle(
                              fontSize: 13,
                              color: Colors.grey[600],
